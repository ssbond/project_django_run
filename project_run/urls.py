...
from app_run.views import company_details, RunViewSet, UserViewSet, RunStartApiView, RunStopApiView, AthleteInfoApiView, \
    ChallengeInfoApiViewSet, PositionApiViewSet, SubscribeToCoachApiView, ChallengesSummaryApiViewSet, RateCoachApiView, \
...
urlpatterns = [
    ...
    path('api/rate_coach/<int:coach_id>/', RateCoachApiView.as_view(), name='rate-coach'),
